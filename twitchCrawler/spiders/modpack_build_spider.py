...
class BuildSpider(scrapy.Spider):
    ...
    def parse_build(self, response):
        ...
        loader.add_value('clientFileLink', response.urljoin(response.xpath("/html/body/div[1]/main/div[1]/div[2]/section/div/div/div/section/section[1]/article/div[1]/div[2]/div[1]/a/@href").get()+'/file'))
        loader.add_value('serverFileLink', response.urljoin(response.xpath('//*[@id="additional-files"]/div/div/div/table/tbody/tr/td[7]/div/a/@href').get()+'/file'))
